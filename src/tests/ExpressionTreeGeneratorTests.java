...
public class ExpressionTreeGeneratorTests {
	...
	/**
	 * Gets the one ExpressionTreeGenerator to use for all the generation.
	 * Generating a new ExpressionTreeGenerator every time shouldn't be necessary,
	 * since the SemanticAnalyzer is always the same.
	 * 
	 * @throws Exception
	 */
	@BeforeAll
